...
import styles from './InternshipPostsStudent.module.css';
...
const InternshipPostsStudent = () => {
  return (
    <div className={styles.container}>
      <div className={styles.headerRow}>
        <h3 className={styles.header}>Recent Internship Posts</h3>
...
export default InternshipPostsStudent;
